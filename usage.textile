...
p. With about 1M jobs in the db+queue, beanstalkd is taking up about 800MB memory and tyrant less than 100MB.  (This is with the full job object stored in the queue: memory pig but faster)
